...
def show_segment():
	...
	img2=np.array(img1)
	res=cv2.resize(img2,(480,480),interpolation=cv2.INTER_CUBIC)
...
header1 = Image.open("header4.png")
header1 = header1.resize((100, 100), Image.ANTIALIAS)
header2 = ImageTk.PhotoImage(image=header1)

header3 = Image.open("header6.png")
header3 = header3.resize((1500, 100), Image.ANTIALIAS)
header4 = ImageTk.PhotoImage(image=header3)

toolbar = Label(root,image=header4)
toolbar.place(x=95,y=0)

toolbar0 = Label(root,image=header2)
toolbar0.place(x=0,y=0)
...
toolbar1 = Label(root,bg="#574395",height=2,width=71, text="QUERY   IMAGE",foreground="white" , font=("Helvetica 9 bold"))
toolbar1.place(x=0,y=103)

toolbar2 = Label(root,bg="#574395",height=2,width=73, text="SEGMENTED   IMAGE",foreground="white" , font=("Helvetica 9 bold"))
toolbar2.place(x=505,y=103)

toolbar3 = Label(root,bg="#574395",height=2,width=72, text="GRAPH",foreground="white" , font=("Helvetica 9 bold"))
toolbar3.place(x=1025,y=103)

toolbar4 = Label(root,bg="black",height=37,width=218,)
toolbar4.place(x=0,y=140)

toolbar5 = Label(root,bg="black",height=4,width=218,)
...
tk.Button(root, text = "INSERT A FLOOR-PLAN IMAGE", command=fileupload , height=1,width=45 , fg="white",bg="#574395", activebackground="#6f602a").place(x=80,y=640)

print filename
text1 = tk.Text(root, height=30,width=60)
text1.place(x= 520 , y=140)
tk.Button(root, text = "SEGMENTED IMAGE", command = show_segment, height=1,width=45 , fg="white",bg="#574395", activebackground="#6f602a").place(x=600,y=640)

tk.Button(root, text = "SEARCH", command=lambda: create_window(filename,new_filename,root), height=2,width=45 , fg="white",bg="#574395", activebackground="#6f602a").place(x=600,y=710)



text2 = tk.Text(root, height=30,width=60)
text2.place(x= 1040 , y=140)
tk.Button(root, text = "GRAPH", command = lambda: show_graph(np.array(adj),text2,root), height=1,width=45 , fg="white",bg="#574395", activebackground="#6f602a").place(x=1120,y=640)
